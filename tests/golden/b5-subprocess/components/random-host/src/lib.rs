...
#[unsafe(no_mangle)]
pub extern "C-unwind" fn hematite__random_host__seed_u64() -> RandomHostSeedU64Result {
    let mut b = [0u8; 8];
    match entropy(&mut b) {
...
#[unsafe(no_mangle)]
pub extern "C-unwind" fn hematite__random_host__seed_u32() -> RandomHostSeedU32Result {
    let mut b = [0u8; 4];
    match entropy(&mut b) {
