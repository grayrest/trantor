...
Fs :: [].{
	...
	stat_at! : Descriptor, List(U8) => Try({ kind : [File, Dir, SymLink, Other], size : U64, accessed_ns : U128, modified_ns : U128, created_ns : U128, readable : Bool, writable : Bool, executable : Bool }, IOErr)
