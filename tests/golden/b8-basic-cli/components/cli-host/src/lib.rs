...
#[unsafe(no_mangle)]
pub extern "C-unwind" fn hematite__cli_host__get_stdout() -> *mut u64 {
    sync_io_core::output_stream(Box::new(std::io::stdout())) as *mut u64
}
#[unsafe(no_mangle)]
pub extern "C-unwind" fn hematite__cli_host__get_stderr() -> *mut u64 {
    sync_io_core::output_stream(Box::new(std::io::stderr())) as *mut u64
}
#[unsafe(no_mangle)]
pub extern "C-unwind" fn hematite__cli_host__get_stdin() -> *mut u64 {
...
#[unsafe(no_mangle)]
pub extern "C-unwind" fn hematite__cli_host__read_line() -> CliInReadLineResult {
...
#[unsafe(no_mangle)]
pub extern "C-unwind" fn hematite__cli_host__read_to_end() -> CliInReadToEndResult {
    let mut buf = Vec::new();
...
fn args() -> &'static Vec<String> {
    ...
    A.get_or_init(|| std::env::args().collect())
}
...
#[unsafe(no_mangle)]
pub extern "C-unwind" fn hematite__cli_host__arg_count() -> u64 { args().len() as u64 }
#[unsafe(no_mangle)]
pub extern "C-unwind" fn hematite__cli_host__arg_at(i: u64) -> RocStr {
    RocStr::from_str(args().get(i as usize).map(String::as_str).unwrap_or(""), abi::host())
}
#[unsafe(no_mangle)]
pub extern "C-unwind" fn hematite__cli_host__env_count() -> u64 { envs().len() as u64 }
#[unsafe(no_mangle)]
pub extern "C-unwind" fn hematite__cli_host__env_at(i: u64) -> AnonStruct82a96c5d55d63488 {
...
#[unsafe(no_mangle)]
pub extern "C-unwind" fn hematite__cli_host__var(name: RocStr) -> CliEnvVarResult {
...
#[unsafe(no_mangle)]
pub extern "C-unwind" fn hematite__cli_host__platform() -> AnonStructBca0d23b5d625934 {
...
#[unsafe(no_mangle)]
pub extern "C-unwind" fn hematite__cli_host__enable_raw_mode() {}
#[unsafe(no_mangle)]
pub extern "C-unwind" fn hematite__cli_host__disable_raw_mode() {}
...
#[unsafe(no_mangle)]
pub extern "C-unwind" fn hematite__cli_host__cwd() -> RocStr { s(std::env::current_dir().unwrap_or_default()) }
#[unsafe(no_mangle)]
pub extern "C-unwind" fn hematite__cli_host__exe_path() -> RocStr { s(std::env::current_exe().unwrap_or_default()) }
#[unsafe(no_mangle)]
pub extern "C-unwind" fn hematite__cli_host__temp_dir() -> RocStr { s(std::env::temp_dir()) }
