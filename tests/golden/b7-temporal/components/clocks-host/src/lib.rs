...
#[unsafe(no_mangle)]
pub extern "C-unwind" fn hematite__clocks_host__wall_now() -> ClocksWallNowResult {
...
#[unsafe(no_mangle)]
pub extern "C-unwind" fn hematite__clocks_host__monotonic_now() -> u64 {
    static START: OnceLock<std::time::Instant> = OnceLock::new();
    START.get_or_init(std::time::Instant::now).elapsed().as_nanos() as u64
}
#[unsafe(no_mangle)]
pub extern "C-unwind" fn hematite__clocks_host__sleep_millis(ms: u64) {
