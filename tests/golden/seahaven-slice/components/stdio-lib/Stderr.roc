...
Stderr :: [].{
	...
	line! = |message| widen_stderr_err(Stdio.stderr_line!(message))
	...
	write! = |message| widen_stderr_err(Stdio.stderr_write!(message))
	...
	write_bytes! = |bytes| widen_stderr_err(Stdio.stderr_write_bytes!(bytes))
}
