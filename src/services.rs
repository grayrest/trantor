...
//! component's contract — `trantor__<c>__init(*const HostCtx)`,
...
pub fn services_rs(r: &Resolved, always: bool) -> Option<String> {
    ...
    s.push_str(
        "\n//! The service contract shim (D-H7-7): the driver's view of every service\n\
         //! component in this world. See trantor's src/services.rs for the shape.\n\
...
mod tests {
    ...
    fn declares_contract_and_wraps_events() {
        ...
        assert!(s.contains("fn trantor__svc_echo__cmd(request: u64, cmd: Echo) -> RocList<Answer<EchoEvent>>;"));
        assert!(s.contains("fn trantor__svc_tick__env() -> TickEnv;"));
