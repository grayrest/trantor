...
//! never rewritten (D13). Only these files are trantor's own output:
...
const GEN: &str = "# GENERATED BY trantor — do not edit. Regenerate with `trantor compose`.";
const GEN_RS: &str = "// GENERATED BY trantor — do not edit. Regenerate with `trantor compose`.";
...
pub fn emit(
    ...
    // crate with the `## @trantor(...)` blocks filled (D-H7-6).
...
/// The workspace is generated under `target/trantor/<world>` (D-H7-38), and
...
const TAGGED_RS: &str = r#"// GENERATED BY trantor — do not edit. Regenerate with `trantor compose`.
//! Build a glue tag-union value from its payload and tag, on either pointer
//! width. See trantor's src/codegen.rs (`TAGGED_RS`).
